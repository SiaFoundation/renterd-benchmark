module go.sia.tech/renterd-benchmark

go 1.17

require (
	github.com/montanaflynn/stats v0.7.0
	go.sia.tech/renterd v0.3.0-beta.0.20230510163400-d5b9fcf4474a
...
require (
	...
	go.sia.tech/core v0.1.12-0.20230503202148-581dd00ac1d2 // indirect
